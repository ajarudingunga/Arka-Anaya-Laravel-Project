var ServiceManageAjax = function () {
    ...
    return {
        ...
        init: function () {
            ...
            // begin first table
            $('#service_center_images').dataTable({
                "aoColumns": [
            ...
            jQuery('#service_center_images_wrapper').on('change', 'tbody tr .checkboxes', function(){
                 $(this).parents('tr').toggleClass("active");
            });

            jQuery('#service_center_images_wrapper .dataTables_filter input').addClass("form-control input-medium input-inline"); // modify table search input
            jQuery('#service_center_images_wrapper .dataTables_length select').addClass("form-control input-xsmall"); // modify table per page dropdown
