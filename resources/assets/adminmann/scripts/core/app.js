...
var App = function () {
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+SITE_URL+'resources/assets/admin/img/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'Please wait...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="'+SITE_URL+'resources/assets/admin/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="'+SITE_URL+'resources/assets/admin/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : 'Please wait...') + '</span></div>');
        },
...
if ($("#currentTime").length > 0) {
    function updateTime() {
        ...
        var timestamp = timestamp.substring(0, timestamp.length - 15);
        currentTime.html('<i class="fa fa-clock-o"></i> '+timestamp);
    }
