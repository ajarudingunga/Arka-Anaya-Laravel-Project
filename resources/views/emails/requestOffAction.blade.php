...
<title>Request off Information</title>
</head>
    	...
    	<td style="padding:35px 0px; background:#303f56;">
        	<table>
				<?php
					...
					$day = $mailData['day'];
					$dayPart = $mailData['dayPart'];
					$approvedBy = $mailData['approvedBy'];
					$managersComments = $mailData['managersComments'];
					$requestStatus = $mailData['requestStatus'];
				?>
            	<tr>
                	<td style="font-size:16px; color:#FFF; padding:0 40px 20px 40px;">Hello {{ $userName }}, the following Time Off request has been {{$requestStatus}}:</td>
                </tr>
