        ...
        <tr>
            <td style="text-align:center; padding:30px 0 30px 0;">
                <a style="font-size:13px; color:#FFF; font-weight:normal;" href="{{ url('/') }}">
                    <img src="{{ $mailDetails['logo'] }}" alt="{{ env('PROJECT_NAME') }}" />
                </a>
            </td>
        </tr>
        <tr>
   	        <td style="padding:35px 0px; background:#303f56;">
       	        <table>
                    ...
                    <tr>
                        <td style="padding:0 40px;"><p style="font-size:14px; line-height:20px; color:#FFF; font-weight:normal;">{{ env('PROJECT_NAME') }} Mobile</p></td>
                    </tr>
                    <tr>
                        <td style="padding:0 40px;"><a style="font-size:13px; color:#FFF; font-weight:normal;" href="{{ $mailDetails['link'] }}">{{ $mailDetails['link'] }}</a></td>
                    </tr>
                    <tr>
