...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ URL::asset('resources/assets/admin/plugins/iCheck/square/blue.css')}}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Arka-Anaya</b> <br><span style="font-size: 20px;">Feel Good With Instant Food</span></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start Arka-Anay Management</p>
    ...
    <form action="{{url('/auth/login')}}" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="email" name="email" class="form-control" placeholder="Admin id">
...
<!-- jQuery 2.2.3 -->
<script src="{{ URL::asset('resources/assets/admin/plugins/jQuery/jquery-2.2.3.min.js')}}"></script>
<!-- Bootstra 3.3.6 -->
<script src="{{ URL::asset('resources/assets/admin/bootstrap/js/bootstrap.min.js')}}"></script>
<!-- iCheck -->
<script src="{{ URL::asset('resources/assets/admin/plugins/iCheck/icheck.min.js')}}"></script>
