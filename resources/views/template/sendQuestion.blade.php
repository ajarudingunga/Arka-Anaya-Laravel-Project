...
<title>Question {{ env('PROJECT_NAME') }}</title>
</head>
    ...
    <tr>
    	<td style="padding:35px 0px; background:#303f56;">
        	<table>
                ...
                <tr>
                    <td style="padding:0 40px; "><p style="font-size:14px; line-height:20px; color:#FFF; font-weight:normal;">You have one new Question/Comment.</p></td>
                </tr>
                <tr>
