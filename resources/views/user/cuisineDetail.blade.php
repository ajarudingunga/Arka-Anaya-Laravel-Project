    ...
    <div id="container">
        <div class="container">
            ...
            <ul class="breadcrumb">
                ...
                <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a  itemprop="url"><span itemprop="title">{{ $var=Helper::getToday()}}</span></a></li>
                ...
                <div id="content" class="col-sm-12">
                    <div itemscope itemtype="http://schema.org/Product">
                        ...
                        <div class="row product-info">
                            <div class="col-sm-6">
                                <div class="image">
                                    <img class="img-responsive" itemprop="image" id="zoom_01" src="{{URL::asset('/resources/uploads/avatars/'.$products->product_image_url)}}"  alt="Product image"  data-zoom-image="{{URL::asset('/resources/uploads/avatars/'.$products->product_image_url)}}" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <ul class="list-unstyled description">

                                    <li><b>Product Id:</b> <span itemprop="mpn">{{$products->product_id}}</span></li>

                                    <li><b></b> <span class="instock">Available</span></li>
                                </ul>
                                <ul class="price-box">
                                    <li class="price" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                        <span itemprop="price">&#x20a8;. {{$products->product_price}}</span>
                                    </li>
                                    <li></li>
                                ...
                                <div id="product">
                                    ...
                                    <div class="cart">
                                        <div>
                                            <a href="{{url('/addtocart', ['id' => $products->product_id])}}"><button type="button" id="button-cart" class="btn btn-primary btn-lg">Add to Cart</button></a>
                                        </div>
                                        <div>
